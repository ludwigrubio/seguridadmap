...
module.exports = {
    ...
    baseDomainUrl: "https://seguridadmap.app.jalisco.gob.mx",
    baseDomainText: "seguridadmap.app.jalisco.gob.mx",
    baseWMSURL: "https://seguridadmap.app.jalisco.gob.mx/geoserver/mapa_jalisco/wms",
    uri: 'http://localhost:',
    constantTemplate:
        '(function () {\n' +
        '    \'use strict\';\n' +
