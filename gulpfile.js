...
gulp.task('content', function () {
    return gulp.src([config.app + 'content/documents/**']).pipe(gulp.dest(config.dist + 'content/documents'));
});
...
gulp.task('assets:prod', ['images', 'content', 'styles', 'html', 'copy:swagger', 'copy:images'], build);
...
gulp.task('ngconstant:dev', function () {
    return ngConstant({
        ...
        constants: {
            ...
            WMS_URL: config.baseWMSURL,
            BASE_DOMAIN: config.baseDomainUrl,
            BASE_DOMAIN_TEXT: config.baseDomainText
        },
