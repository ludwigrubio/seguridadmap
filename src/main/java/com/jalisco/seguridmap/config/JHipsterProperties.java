...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "seguridMap@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "seguridMap API";

        private String description = "seguridMap API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "seguridMap";
